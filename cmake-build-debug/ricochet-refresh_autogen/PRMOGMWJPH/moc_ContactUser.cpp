...
void ContactUser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ContactUser *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ContactUser::*)(const QWeakPointer<Protocol::Connection> & );
        ...
        {
            using _t = void (ContactUser::*)(ContactUser * );
...
QT_INIT_METAOBJECT const QMetaObject ContactUser::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_ContactUser.data,
    qt_meta_data_ContactUser,
    qt_static_metacall,
    nullptr,
    nullptr
} };
