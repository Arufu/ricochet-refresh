...
void OutgoingContactRequest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OutgoingContactRequest *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (OutgoingContactRequest::*)(int , int );
        ...
        {
            using _t = void (OutgoingContactRequest::*)();
        ...
        {
            using _t = void (OutgoingContactRequest::*)(const QString & );
...
QT_INIT_METAOBJECT const QMetaObject OutgoingContactRequest::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_OutgoingContactRequest.data,
    qt_meta_data_OutgoingContactRequest,
    qt_static_metacall,
    nullptr,
    nullptr
} };
