...
void ContactIDValidator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ContactIDValidator *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ContactIDValidator::*)() const;
...
QT_INIT_METAOBJECT const QMetaObject ContactIDValidator::staticMetaObject = { {
    &QRegularExpressionValidator::staticMetaObject,
    qt_meta_stringdata_ContactIDValidator.data,
    qt_meta_data_ContactIDValidator,
    qt_static_metacall,
    nullptr,
    nullptr
} };
