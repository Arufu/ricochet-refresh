...
void Tor::TorProcessPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TorProcessPrivate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Tor::TorProcessPrivate::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Tor__TorProcessPrivate.data,
    qt_meta_data_Tor__TorProcessPrivate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
