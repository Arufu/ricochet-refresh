...
void Tor::TorControl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TorControl *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (TorControl::*)(int , int );
...
QT_INIT_METAOBJECT const QMetaObject Tor::TorControl::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Tor__TorControl.data,
    qt_meta_data_Tor__TorControl,
    qt_static_metacall,
    nullptr,
    nullptr
} };
