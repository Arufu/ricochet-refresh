...
void Tor::SetConfCommand::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SetConfCommand *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SetConfCommand::*)(int );
...
QT_INIT_METAOBJECT const QMetaObject Tor::SetConfCommand::staticMetaObject = { {
    &TorControlCommand::staticMetaObject,
    qt_meta_stringdata_Tor__SetConfCommand.data,
    qt_meta_data_Tor__SetConfCommand,
    qt_static_metacall,
    nullptr,
    nullptr
} };
