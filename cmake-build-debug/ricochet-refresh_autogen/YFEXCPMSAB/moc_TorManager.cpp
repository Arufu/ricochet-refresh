...
void Tor::TorManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TorManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Tor::TorManager::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Tor__TorManager.data,
    qt_meta_data_Tor__TorManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
