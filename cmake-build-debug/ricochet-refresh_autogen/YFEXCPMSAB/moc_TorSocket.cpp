...
void Tor::TorSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TorSocket *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Tor::TorSocket::staticMetaObject = { {
    &QTcpSocket::staticMetaObject,
    qt_meta_stringdata_Tor__TorSocket.data,
    qt_meta_data_Tor__TorSocket,
    qt_static_metacall,
    nullptr,
    nullptr
} };
