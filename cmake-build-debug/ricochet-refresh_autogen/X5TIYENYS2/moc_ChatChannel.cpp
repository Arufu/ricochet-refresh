...
void Protocol::ChatChannel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ChatChannel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ChatChannel::*)(MessageId , bool );
        ...
        {
            using _t = void (ChatChannel::*)(const QString & , const QDateTime & , MessageId );
...
QT_INIT_METAOBJECT const QMetaObject Protocol::ChatChannel::staticMetaObject = { {
    &Channel::staticMetaObject,
    qt_meta_stringdata_Protocol__ChatChannel.data,
    qt_meta_data_Protocol__ChatChannel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
