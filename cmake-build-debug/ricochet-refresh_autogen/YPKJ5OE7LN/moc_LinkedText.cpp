...
void LinkedText::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LinkedText *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject LinkedText::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_LinkedText.data,
    qt_meta_data_LinkedText,
    qt_static_metacall,
    nullptr,
    nullptr
} };
